...
\
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x0000001C, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* SystemMode */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 17, 203 }, \
  { ZAP_CLUSTER_INDEX(17), 4, 30 }, \
}
