...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000080, 66, ZAP_TYPE(OCTET_STRING), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderVerificationKey */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000081, 17, ZAP_TYPE(OCTET_STRING), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderGroupIdentifier */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000082, 17, ZAP_TYPE(OCTET_STRING), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroReaderGroupSubIdentifier */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000083, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroExpeditedTransactionSupportedProtocolVersions */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000084, 17, ZAP_TYPE(OCTET_STRING), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroGroupResolvingKey */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000085, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroSupportedBLEUWBProtocolVersions */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000086, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroBLEAdvertisingVersion */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000087, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* NumberOfAliroCredentialIssuerKeysSupported */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000088, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* NumberOfAliroEndpointKeysSupported */  \
